  ...
  data.forEach((quizData, i) => {
    ...
    quizHTML += `<div class="m-3 py-3 px-4 shadow-sm rounded">
                                  <div class="flex items-center">
                                    ...
                                    <p class="text-gray-800 text-sm">${quizData.question}</p>
                                  </div>
                                  <div class="grid grid-cols-2 gap-4 mt-5">
                                    ${displayQuizOptions(quizData.options, i)}
                                  </div>
                                </div>`
  });
  //Set the concatenated HTML for all quizzes into the quizContainer
